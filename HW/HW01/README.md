...
Были протестированы модели без/с категориальными признаками. Полученные метрики качества для каждой модели представлены в таблице:
...
> **Примечание: Бизнес-метрика**
>
>Доля прогнозов стоимости, отличающейся от реальных цен на автомобили не более чем на 10% (в одну или другую сторону)
...
- обработка возможных ошибок при загрузке `csv`-файла
